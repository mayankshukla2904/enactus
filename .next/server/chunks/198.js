...
var get_nonce_1 = __webpack_require__(6420);
...
var dist = __webpack_require__(9837);
...
function createContext2(rootComponentName, defaultContext) {
  const Context = react_.createContext(defaultContext);
...
var useLayoutEffect2 = Boolean(globalThis?.document) ? react_.useLayoutEffect : () => {
};
...
function useStateMachine(initialState, machine) {
  return react_.useReducer((state, event) => {
...
var Presence = (props) => {
  ...
  const child = typeof children === "function" ? children({ present: presence.isPresent }) : react_.Children.only(children);
  const ref = (0,dist/* useComposedRefs */.e)(presence.ref, getElementRef(child));
  const forceMount = typeof children === "function";
  return forceMount || presence.isPresent ? react_.cloneElement(child, { ref }) : null;
};
Presence.displayName = "Presence";
function usePresence(present) {
  const [node, setNode] = react_.useState();
  const stylesRef = react_.useRef({});
  const prevPresentRef = react_.useRef(present);
  const prevAnimationNameRef = react_.useRef("none");
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: react_.Children.map(children, (child) => /* @__PURE__ */ (0,jsx_runtime_.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlay = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? /* @__PURE__ */ (0,jsx_runtime_.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(DialogOverlayImpl, { ...overlayProps, ref: forwardedRef }) }) : null;
  }
);
...
var DialogContent = react_.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime_.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? /* @__PURE__ */ (0,jsx_runtime_.jsx)(DialogContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ (0,jsx_runtime_.jsx)(DialogContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8038);
/* harmony import */ var _radix_ui_react_primitive__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5585);
...
/* harmony import */ var _radix_ui_react_slot__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9818);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8038);
/* harmony import */ var _radix_ui_react_compose_refs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9837);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6786);
